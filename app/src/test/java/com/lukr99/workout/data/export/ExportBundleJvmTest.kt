...
/**
 * The cross-device contract: our `1.2` bundle round-trips through JSON unchanged, and a hand-crafted
...
class ExportBundleJvmTest {
    ...
    fun supportsAllPublishedVersions() {
        assertEquals(setOf("1.0", "1.1", "1.2"), ExportBundle.SUPPORTED_VERSIONS)
        assertEquals("1.2", ExportBundle.CURRENT_VERSION)
    }
